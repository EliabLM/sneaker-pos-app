...
const Actions = ({ location }: { location: Location }) => {
  ...
  return (
    <>
      <ResponsiveDialog
        ...
        description='¿Estás seguro de que quieres eliminar este local?'
      >
      ...
      >
        <CreateEditForm setOpen={setIsEditOpen} location={location} />
      </ResponsiveDialog>
